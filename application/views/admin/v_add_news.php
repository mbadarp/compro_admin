               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item ">
                                    <a href="<?php echo base_url() . 'admin/news/add_news' ?>" class="nav-link active">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo base_url() . 'admin/news/category' ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo base_url() . 'admin/product/add_product' ?>" class="nav-link">
                                        <i class="fas fa-plus nav-icon"></i>
                                        <p>Add Product</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo base_url() . 'admin/services/add_services' ?>" class="nav-link">
                                        <i class="fas fa-plus nav-icon"></i>
                                        <p>Add Services</p>
                                    </a>
                                </li>
